...
public class PrepareContext {
    ...
    private static final String JNDI_DATA_SOURCE = "osgi:service/javax.sql.DataSource/(osgi.jndi.service.name=jdbc/User_H2)";
	...
	public static EntityManagerFactory createEMF() throws Exception {		
		...
		try {
	    	return Persistence.createEntityManagerFactory("user-jpa",
	    			ImmutableMap.of(
