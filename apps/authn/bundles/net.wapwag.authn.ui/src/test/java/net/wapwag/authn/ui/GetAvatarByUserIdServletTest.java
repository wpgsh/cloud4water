...
public class GetAvatarByUserIdServletTest extends BaseServletTest{
    ...
    private static final String LOGIN_CONTEXT_PATH = "http://localhost:" + port + "/authn/getAvatarByUserIdServlet?userId=1";
    
    
	public GetAvatarByUserIdServletTest() {
	...
	protected Servlet createServlet() throws Exception {
		return new GetAvatarByUserIdServlet();
	}
