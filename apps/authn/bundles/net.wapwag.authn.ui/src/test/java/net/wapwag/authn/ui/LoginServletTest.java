...
public class LoginServletTest extends BaseServletTest{
    ...
    private static final String LOGIN_CONTEXT_PATH = "http://localhost:" + port + "/authn/loginServlet?userName=test1&passWord=dfdf";
    
    private static final String LOGIN_CONTEXT_WRONG_PATH = "http://localhost:" + port + "/authn/loginServlet?userName=test1&passWord=123123";
	...
	public void testDoPostHttpServletRequestHttpServletResponse_wrongpassword() throws Exception {
		QueryComponentResponse resqponse = getAcceptQueryComponent(LOGIN_CONTEXT_WRONG_PATH, APPLICATION_X_WWW_FORM_URLENCODED);
		assertEquals(HttpServletResponse.SC_OK, resqponse.responseCode);
	}
