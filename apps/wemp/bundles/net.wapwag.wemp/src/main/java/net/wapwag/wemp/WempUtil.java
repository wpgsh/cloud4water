...
/**
 * Wemp util for some general method
 * Created by Administrator on 2016/11/24 0024.
 */
@SuppressWarnings("Duplicates")
public final class WempUtil {

    private static final Logger logger = LoggerFactory.getLogger(WempUtil.class);
    ...
    static {
        try {
            ...
            String WEMP_SECRET_KEY = constantMap.get("wemp_secret_key");
            WEMP_SECRET_KEY_BYTES = WEMP_SECRET_KEY.getBytes(UTF8);
